        ...
        <form style="margin: 0 auto" class="layui-form layui-form-pane"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="pname" lay-verify="required" value="<s:property value="model.pname"/>"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="market_price" lay-verify="required" value="<s:property value="model.market_price"/>"
                           placeholder="请输入" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="shop_price" lay-verify="required" value="<s:property  value="model.shop_price"/>"
                           placeholder="请输入" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    ...
                    <textarea placeholder="请输入内容" name="pdesc" class="layui-textarea" value="<s:property  value="model.pdesc"/>"> </textarea>
                </div>
            </div>
