    ...
    <s:iterator var="cs" value="pageBean.list" status="status">
        <tr>
            ...
            <td>
                ...
                <button type="button" class="btn btn-danger btn-sm" data-target="#myModal<s:property value="#cs.csid"/>"
                        data-toggle="modal">删除
                </button>

                <div class="modal fade " id="myModal<s:property value="#cs.csid"/>" tabindex="-1" role="dialog"
